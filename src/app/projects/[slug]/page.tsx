  ...
  return (
    <article className="min-h-screen px-4 pt-28 pb-20 md:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative mt-8 aspect-[21/9] overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-950 to-violet-950">
          <Image
        ...
        <section className="mt-12">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">Overview</h2>
          <p className="mt-4 text-white/60 leading-relaxed">{project.overview}</p>
        </section>

        <section className="mt-10">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">My role</h2>
          <p className="mt-4 text-white/60">{project.role}</p>
        </section>

        <section className="mt-10">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">Process</h2>
        ...
        <section className="mt-10">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">Results</h2>
        ...
        <section className="mt-10">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">Technologies</h2>
        ...
        <section className="mt-12">
          <h2 className="text-sm tracking-[0.2em] text-indigo-400 uppercase">Gallery</h2>
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {project.gallery.map((src, i) => (
              <div
                key={src}
                className="relative aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-indigo-950/80 to-violet-950/50"
              >
